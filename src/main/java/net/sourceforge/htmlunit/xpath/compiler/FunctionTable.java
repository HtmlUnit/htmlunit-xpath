...
public class FunctionTable {
  ...
  static {
    ...
    m_functions[FUNC_BOOLEAN] = net.sourceforge.htmlunit.xpath.functions.FuncBoolean.class;
    m_functions[FUNC_LANG] = net.sourceforge.htmlunit.xpath.functions.FuncLang.class;
    m_functions[FUNC_NUMBER] = net.sourceforge.htmlunit.xpath.functions.FuncNumber.class;
    m_functions[FUNC_FLOOR] = net.sourceforge.htmlunit.xpath.functions.FuncFloor.class;
    m_functions[FUNC_CEILING] = net.sourceforge.htmlunit.xpath.functions.FuncCeiling.class;
