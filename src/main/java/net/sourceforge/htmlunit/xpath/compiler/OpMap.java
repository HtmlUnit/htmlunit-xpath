...
//  public int m_tokenQueueSize = 0;
  ...
  * Set the op at index to the given int.
     ...
     throws javax.xml.transform.TransformerException
  {
    ...
    {
      error(net.sourceforge.htmlunit.xpath.res.XPATHErrorResources.ER_UNKNOWN_OPCODE,
  ...
  public void error(String msg, Object[] args) throws javax.xml.transform.TransformerException
  {
    ...
    java.lang.String fmsg = net.sourceforge.htmlunit.xpath.res.XSLMessages.createXPATHMessage(msg, args);
