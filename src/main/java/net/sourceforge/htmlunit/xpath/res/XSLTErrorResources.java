  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      {ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports not allowed in a xsl:for-each"},
      {
        ...
        "Cannot use a DTMLiaison for an output DOM node... pass a net.sourceforge.htmlunit.xpath.DOM2Helper instead!"
      },
      {
        ER_CANT_USE_DTM_FOR_INPUT,
        "Cannot use a DTMLiaison for a input DOM node... pass a net.sourceforge.htmlunit.xpath.DOM2Helper instead!"
      },
