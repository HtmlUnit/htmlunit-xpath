...
import net.sourceforge.htmlunit.xpath.xml.utils.NodeConsumer;
...
public class DTMTreeWalker {
   ...
   * (preorder) and endNode (postorder) are invoked for each node as we traverse over them, with the
   * result that the node is written out to m_contentHandler.
   *
