...
public class DOM2DTMdefaultNamespaceDeclarationNode implements Attr, TypeInfo {
  ...
  /**
   * Associate an object to a key on this node. The object can later be retrieved from this node by
   * calling <code>getUserData</code> with the same key.
   *
  ...
  /**
   * DOM Level 3: Experimental This method checks if the specified <code>namespaceURI</code> is the
