...
final class ChunkedIntArray {
  ...
  /**
   * Append a 4-integer record to the CIA, starting with record 1. (Since arrays are initialized to
   * all-0, 0 has been reserved as the "unknown" value in DTM.)
   *
  ...
  /**
   * Overwrite an entire (4-integer) record at the specified index. Mostly used to create record 0,
   * the Document node.
   *
   ...
   * overhead when code will access several columns of the record.
   *
   * @param position int Record number
