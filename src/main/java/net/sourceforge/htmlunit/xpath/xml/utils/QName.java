...
public class QName implements java.io.Serializable {
  ...
  public QName(String qname, PrefixResolver resolver, boolean validate) {
    ...
    if (indexOfNSSep > 0) {
      ...
      throw new RuntimeException(
          XMLMessages.createXMLMessage(XMLErrorResources.ER_NAME_CANT_START_WITH_COLON, null));
    } else {
      _localName = qname;
    }
  ...
  /**
   * Override equals and agree that we're equal if the passed object is a string and it matches the
   * name of the arg.
   *
