 ...
 * $Id$
 */
package net.sourceforge.htmlunit.xpath.xml.utils.res;
...
public class XResourceBundle extends ListResourceBundle
{
  ...
  public static final String ERROR_RESOURCES =
    "net.sourceforge.htmlunit.xpath.res.XSLTErrorResources", XSLT_RESOURCE =
    "net.sourceforge.htmlunit.xpath.xml.utils.res.XResourceBundle", LANG_BUNDLE_NAME =
    "net.sourceforge.htmlunit.xpath.xml.utils.res.XResources", MULT_ORDER =
