...
public class TreeWalker
{
  ...
  {
    if(m_contentHandler instanceof net.sourceforge.htmlunit.xpath.xml.dtm.ref.dom2dtm.DOM2DTM.CharacterNodeHandler)
    {
      ((net.sourceforge.htmlunit.xpath.xml.dtm.ref.dom2dtm.DOM2DTM.CharacterNodeHandler)m_contentHandler).characters(node);
    }
    else
    {
