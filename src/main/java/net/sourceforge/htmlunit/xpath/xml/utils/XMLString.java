 ...
 * <code>net.sourceforge.htmlunit.xpath.xml.utils.FastStringBuffer</code>s, or other character data.
 * By using XMLString, character copies can be reduced in the XML pipeline.
 */
public interface XMLString {
   ...
   * unsatisfactory ordering for certain locales. The java.text package provides <em>collators</em>
   ...
   *     the character sequence represented by this object; <code>false</code> otherwise. Note that
   *     the result will be <code>true</code> if the argument is the empty string or is equal to
   *     this <code>String</code> object as determined by the {@link #equals(Object)} method.
   ...
   * <code>String</code> object, then the index of the first such occurrence is returned -- that is,
   * the smallest value <i>k</i> such that:
   *
   * <blockquote>
   *
   * <pre>
   ...
   * index of the first such occurrence is returned--that is, the smallest value <i>k</i> such that:
   *
   * <blockquote>
   *
   * <pre>
   ...
   * searching backward starting at the specified index. That is, the index returned is the largest
   ...
   *     the same effect as if it were equal to one less than the length of this string: this entire
   *     string may be searched. If it is negative, it has the same effect as if it were -1: -1 is
   *     returned.
   * @return the index of the last occurrence of the character in the character sequence represented
   *     by this object that is less than or equal to <code>fromIndex</code>, or <code>-1</code> if
   ...
   * starting at the specified index. The integer returned is the smallest value <i>k</i> such that:
   *
   * <blockquote>
   *
   * <pre>
   ...
   *     smaller than <code>fromIndex</code>, then the index of the first character of the first
   *     such substring is returned. If it does not occur as a substring starting at <code>
   ...
   *     were equal to the length of this string: this entire string may be searched. If it is
   ...
   *     starting index no greater than <code>fromIndex</code>, then the index of the first
  ...
  /**
   * Converts all of the characters in this <code>String</code> to lower case using the rules of the
   * default locale, which is returned by <code>Locale.getDefault</code>.
   *
   * <p>
   *
   * @return the string, converted to lowercase.
   ...
   * <code>toUpperCase</code> method defined by <code>Character</code>, then the original string is
   * returned.
   *
   ...
   * Character.toUpperCase</code> to the corresponding character of this <code>String</code> object.
   *
   * <p>Examples:
   *
   * <blockquote>
   ...
   *
   * <p>If this <code>String</code> object represents an empty character sequence, or the first and
   * last characters of character sequence represented by this <code>String</code> object both have
   * codes greater than <code>'&#92;u0020'</code> (the space character), then a reference to this
   ...
   * greater than <code>'&#92;u0020'</code>, and let <i>m</i> be the index of the last character in
   * the string whose code is greater than <code>'&#92;u0020'</code>. A new <code>String</code>
   * object is created, representing the substring of this string that begins with the character at
   * index <i>k</i> and ends with the character at index <i>m</i>-that is, the result of <code>
