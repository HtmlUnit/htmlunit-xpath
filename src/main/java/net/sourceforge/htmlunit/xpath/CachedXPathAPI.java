...
public class CachedXPathAPI
{
  ...
  */
   ...
   * its own {@link net.sourceforge.htmlunit.xpath.xml.dtm.DTMManager}.
   ...
   * {@link net.sourceforge.htmlunit.xpath.xml.dtm.DTM}.</p>
   */
   ...
   * ({@link net.sourceforge.htmlunit.xpath.xml.dtm.DTM}) and previously established location
   * state.</p>
   ...
   * to a single {@link net.sourceforge.htmlunit.xpath.xml.dtm.DTM} at this time.  Similarly,
