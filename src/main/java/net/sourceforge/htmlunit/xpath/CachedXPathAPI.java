...
public class CachedXPathAPI {
   ...
   * net.sourceforge.htmlunit.xpath.xml.dtm.DTMManager}. Good choice for simple uses.
   *
   * <p>Note that any particular instance of {@link CachedXPathAPI} must not be operated upon by
   * multiple threads without synchronization; we do not currently support multithreaded access to a
   * single {@link net.sourceforge.htmlunit.xpath.xml.dtm.DTM}.
   */
   ...
   * That allows sharing document models ({@link net.sourceforge.htmlunit.xpath.xml.dtm.DTM}) and
   ...
   * net.sourceforge.htmlunit.xpath.xml.dtm.DTM} at this time. Similarly, any particular instance of
