...
//      return ((DOMSource) source).getNode();
          ...
          throws TransformerException
  {
    ...
    {      
      ...
      DTM dtm;
      if(null != xowner && xowner instanceof net.sourceforge.htmlunit.xpath.xml.dtm.DTMWSFilter)
      {
        dtm = xctxt.getDTM(source, false, 
                          (net.sourceforge.htmlunit.xpath.xml.dtm.DTMWSFilter)xowner, false, true);
      }
      else
      {
