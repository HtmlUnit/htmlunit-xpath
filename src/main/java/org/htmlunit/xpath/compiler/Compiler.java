...
/**
 * An instance of this class compiles an XPath string expression into an
...
public class Compiler extends OpMap {
     ...
     *
     * @param errorHandler Error listener where messages will be sent, or null if
     ...
     * @return reference to {@link org.htmlunit.xpath.operations.Operation}
     *         instance.
     * @throws TransformerException if there is a syntax or other error.
     */
     ...
     *
     * @param opPos The current position in the m_opMap array.
     * @return reference to {@link org.htmlunit.xpath.operations.NotEquals}
     *         instance.
     * @throws TransformerException if an error occurs creating the Expression.
     */
     ...
     * {@link org.htmlunit.xpath.axes.LocPathIterator} children.
     *
     * @param opPos The current position in the m_opMap array.
     * @return reference to {@link org.htmlunit.xpath.axes.LocPathIterator}
     *         instance.
     * @throws TransformerException if an error occurs creating the Expression.
     */
     ...
     * {@link org.htmlunit.xpath.axes.AxesWalker} children.
     *
     * @param opPos The current position in the m_opMap array.
     * @return reference to {@link org.htmlunit.xpath.axes.LocPathIterator}
     *         instance.
     ...
     *
     * @param opPos The current position in the m_opMap array.
     * @return reference to {@link org.htmlunit.xpath.patterns.UnionPattern}
     *         instance.
     * @throws TransformerException if an error occurs creating the Expression.
     */
     ...
     *
     * @param opPos The current position in the m_opMap array.
     * @return reference to {@link org.htmlunit.xpath.patterns.StepPattern}
     *         instance.
     * @throws TransformerException if an error occurs creating the Expression.
     */
        ...
        case OpCodes.NODETYPE_NODE:
            ...
            default -> {
                if (getOp(0) == OpCodes.OP_MATCHPATTERN) {
                    yield ~DTMFilter.SHOW_ATTRIBUTE & ~DTMFilter.SHOW_DOCUMENT & ~DTMFilter.SHOW_DOCUMENT_FRAGMENT;
                }
     ...
     * @throws TransformerException if an error occurs creating the Expression.
     */
    protected StepPattern stepPattern(int opPos, final int stepCount, final StepPattern ancestorPattern)
        ...
        case OpCodes.FROM_ROOT:
            ...
            pattern = new StepPattern(DTMFilter.SHOW_DOCUMENT | DTMFilter.SHOW_DOCUMENT_FRAGMENT, Axis.PARENT);
            break;
        case OpCodes.MATCH_ATTRIBUTE:
            if (DEBUG) {
                System.out.println("MATCH_ATTRIBUTE: " + getStepLocalName(startOpPos) + ", " + currentPattern);
            }
            argLen = getArgLengthOfStep(opPos);
            opPos = getFirstChildPosOfStep(opPos);
        ...
        case OpCodes.MATCH_ANY_ANCESTOR:
            if (DEBUG) {
                System.out.println("MATCH_ANY_ANCESTOR: " + getStepLocalName(startOpPos) + ", " + currentPattern);
            }
            argLen = getArgLengthOfStep(opPos);
            opPos = getFirstChildPosOfStep(opPos);
        ...
        case OpCodes.MATCH_IMMEDIATE_ANCESTOR:
            if (DEBUG) {
                System.out.println("MATCH_IMMEDIATE_ANCESTOR: " + getStepLocalName(startOpPos) + ", " + currentPattern);
            }
            argLen = getArgLengthOfStep(opPos);
            opPos = getFirstChildPosOfStep(opPos);
            pattern = new StepPattern(getWhatToShow(startOpPos), getStepNS(startOpPos), getStepLocalName(startOpPos),
     ...
     * @return reference to array of {@link org.htmlunit.xpath.Expression}
     *         instances.
     * @throws TransformerException if an error occurs creating the Expression.
     */
     ...
     *                   {@link org.htmlunit.xpath.Expression}s, that will be filled
     *                   in.
