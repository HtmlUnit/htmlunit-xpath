...
class Lexer {
    ...
    /**
     * Record the current position on the token queue as long as this is a top-level
     * element. Must be called before the next token is added to the m_tokenQueue.
     *
    ...
    /**
     * When a seperator token is found, see if there's a element name or the like to
     * map.
     *
