...
public class XPathParser {
     ...
     *
     * <p>
     * Set to {@code true} before the fallback call and cleared in a {@code finally}
     * block, so a reused parser instance is always left clean.
     */
    ...
    /**
     * Given a string, init an XPath object for selections, in order that a parse
     ...
     * @param namespaceContext An object that is able to resolve prefixes in the
     *                         XPath to namespaces.
    ...
    /**
     * Given a string, init an XPath object for pattern matches, in order that a
     ...
     * @throws javax.xml.transform.TransformerException in case of error
     */
    public void initMatchPattern(final Compiler compiler, final String expression,
            final PrefixResolver namespaceContext) throws javax.xml.transform.TransformerException {
    ...
    /**
     * Allow an application to register an error event handler, where syntax errors
     * will be sent. If the error listener is not set, syntax errors will be sent to
     * System.err.
     *
     ...
     * @throws javax.xml.transform.TransformerException in case of error
     */
    private void consumeExpected(final char expected) throws javax.xml.transform.TransformerException {
     ...
     *             be null.
     * @throws TransformerException if the current ErrorListener determines to throw
     *                              an exception.
     */
     ...
     *         found in {@link org.htmlunit.xpath.compiler.FunctionTable}, but may
     ...
     * hand side expression. The results of the right hand side expressions are node
     * sets. The result of the left hand side UnionExpr is the union of the results
     ...
     *         FilterExpr with one or more Predicates; FILTER_MATCH_PRIMARY, if this
     *         method successfully matched a FilterExpr that was just a PrimaryExpr;
     *         or FILTER_MATCH_FAILED, if this method did not match a FilterExpr
     * @throws javax.xml.transform.TransformerException in case of error
     */
     ...
     *         {@link org.htmlunit.xpath.compiler.Keywords}.
     * @throws javax.xml.transform.TransformerException in case of error
     */
     ...
     * Literal ')'
     *
     * @param axesType FROM_XXX axes type, found in
     *                 {@link org.htmlunit.xpath.compiler.Keywords}.
     * @throws javax.xml.transform.TransformerException in case of error
     */
