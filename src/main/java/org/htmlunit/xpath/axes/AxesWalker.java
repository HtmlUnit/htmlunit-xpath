...
public class AxesWalker extends PredicatedNodeTest implements Cloneable, PathComponent {
    ...
    /**
     * Do a deep clone of this walker, including next and previous walkers. If this AxesWalker is
    ...
    AxesWalker cloneDeep(final WalkingIterator cloneOwner, final Vector<AxesWalker> cloneList)
        ...
        // If you don't check for the cloneList here, you'll go into a recursive infinite loop.
        if (null != cloneList) {
