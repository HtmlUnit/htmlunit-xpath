 ...
 * {@link org.htmlunit.xpath.objects.XObject}, normally has a location within a
 * document or DOM, can send error and warning events, and normally do not hold
 * state and are meant to be immutable once construction has completed. An
 * exception to the immutability rule is iterators and walkers, which must be
...
public abstract class Expression implements ExpressionNode, XPathVisitable {
    ...
    /**
     * Execute an expression in the XPath runtime context, and return the result of
     * the expression.
     *
    ...
    /**
     * Execute an expression in the XPath runtime context, and return the result of
     * the expression, but tell that a "safe" object doesn't have to be returned.
     ...
     * @throws TransformerException                     thrown if the active
     *                                                  ProblemListener decides the
     ...
     * @return true if this objects class and the expr object's class are the same,
     *         and the data contained within both objects are considered equal.
     */
    public abstract boolean deepEquals(Expression expr);

    /**
     * This is a utility method to tell if the passed in class is the same class as
     * this. It is to be used by the deepEquals method. I'm bottlenecking it here
     * because I'm not totally confident that comparing the class objects is the
     * best way to do this.
     *
     ...
     *              in {@link org.htmlunit.xpath.res.XPATHErrorResources}, which is
     *              a key for a format string.
     * @param args  An array of arguments represented in the format string, which
     *              may be null.
     * @throws TransformerException                     if the current ErrorListoner
     *                                                  determines to throw an
     *                                                  exception.
     * @throws javax.xml.transform.TransformerException if any
     */
